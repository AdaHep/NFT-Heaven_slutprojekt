...
export const getDeliveryOption = async (req: Request, res: Response, next: NextFunction) => {
    try{
...
export const addDeliveryOption = async (req: Request, res: Response, next: NextFunction) => {
    try {
